...
**決策**:
- Supported code files use a normalized tree-sitter structure for TypeScript/JavaScript, Python, Go, Rust, Java, Bash, `.c` GNU C source, and C++ source/typed headers during indexing.
