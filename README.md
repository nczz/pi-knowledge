...
- **Code-aware indexing**: recursive AST chunking for TypeScript/JavaScript, Python, Go, Rust, Java, Bash, and GNU C, with bounded fallback chunks for oversized declarations.
...
| **Code-aware chunking** | ✅ (TS/JS/Py/Go/Rust/Java/Bash/C) | ❌ | ❌ |
