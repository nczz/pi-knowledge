...
- **Code-aware indexing**: recursive AST chunking for TypeScript/JavaScript, Python, Go, Rust, Java, and Bash, with bounded fallback chunks for oversized declarations.
...
| **Code-aware chunking** | ✅ (TS/JS/Py/Go/Rust/Java/Bash) | ❌ | ❌ |
